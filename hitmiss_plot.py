...
axes[0].set_xticklabels([str(x) for x in threshes], fontsize=22)
axes[0].set_xlabel("Z threshold", fontsize=22)
axes[0].set_ylabel("# of identified components", fontsize=22)
...
axes[1].set_xticklabels([str(x) for x in threshes], fontsize=22)
axes[1].set_xlabel("Z threshold", fontsize=22)
